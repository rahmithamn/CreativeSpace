...
<?php
		...
		$sql = "SELECT 
					...
					student_header
				FROM 
					student_profile WHERE student_uname = '$uname_visit';";
				...
				<li class="profil">
					<div class="profile">
						<div class="profile-img">
							<?php
									$propic_query = "SELECT recruiter_img FROM recruiter_profile WHERE recruiter_uname = '$uname_now';";
                                    ...
                                    if($resultCheck_propic > 0) {
                                        while ($row_propic = mysqli_fetch_assoc($result_propic)) {
                                            $s_propic = $row_propic['recruiter_img'];
                                            if(!$s_propic == null) {
		...
		<div class="main-profile">
			<div class="profile-descript">
				...
				<div class="more-profile">
					...
					<div class="uname-name"><center>@<?php echo $row['student_uname'];?></center></div>
			...
			<?php
					...
					$query_profile_tl = "SELECT student_img, 
																...
																FROM student_profile, 
																			content 
																WHERE student_profile.student_uname = '$uname_visit' 
																AND content.uname='$uname_visit' ORDER BY content.upload_date DESC;";
			...
			<div class="profile-timeline">
				<div class="page-divider">
					<a href="profile-visit-rec.php?uname_visit=<?php echo $uname_visit;?>" class="active-profile">Content</a>
					<a href="profile-job-rec.php?uname_visit=<?php echo $uname_visit;?>" class="not-active-profile">Job Experience</a>
				</div>
				<div class="timelines">
                <div class="timelines-title">
					<b>Content Timelines </b>
