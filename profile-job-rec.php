    ...
    <div class="main-header" style="background-image:url('<?php echo $headerbg;?>');">
		<div class="main-profile">
			...
			<div class="profile-timeline">
                ...
                <a href="profile-visit-rec.php?uname_visit=<?php echo $uname_visit;?>" class="not-active-profile">Content</a>
					<a href="profile-job-visit.php?uname_visit=<?php echo $uname_visit;?>" class="active-profile">Job Experience</a>
				</div>
				<div class="timelines">
			...
			<?php
				$job_query = "SELECT a.recruiter_img,
								...
								WHERE c.uname_stu_apply = '$uname_visit'
