...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/job-apply.css">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
</head>
<body>
<?php
	...
	?>
		<div class="timelines">
			<div class="timelines-title">
                ...
                <?php
                $job_apply = addslashes($_GET['apply_job']);
				$job_query = "SELECT recruiter_img,
                                ...
                                AND job_application.id_jobapp = '$job_apply';";
            ...
            <div class="form-apply">
                <span>Describe why you are eligible to take the job</span>
                <form action="function/apply.php" method="POST">
                <div class="form-desc">
                    <textarea name="explanation"></textarea>
                    <input type="text" name="id_job" value="<?php echo $job_apply;?>"  class="id-apply">
                </div>
                <input type="submit" value="Send" name="send-apply">
                </form>
            </div>
		</div>
	</div>
