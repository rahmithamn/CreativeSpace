		...
		<div class="main-profile">
			...
			<div class="profile-timeline">
				<div class="page-divider">
					<a href="profile-visit.php?uname_visit=<?php echo $uname_visit;?>" class="active-profile">Content</a>
					<a href="profile-job-visit.php?uname_visit=<?php echo $uname_visit;?>" class="not-active-profile">Job Experience</a>
				</div>
				<div class="timelines">
