		...
		<div class="main-profile">
			<div class="profile-descript">
				...
				<div class="more-profile">
					...
					<div class="uname-name"><center>@<?php echo $uname_visit;?></center></div>
			...
			<div class="profile-timeline">
                ...
                <a href="profile-visit.php?uname_visit=<?php echo $uname_visit;?>" class="not-active-profile">Content</a>
